	...
	void CreateWildPokemonPanel() {
		...
		btnEnableTimebasedPokemon.addActionListener(new ActionListener()  {
			public void actionPerformed(ActionEvent e)  {
				...
				int result = JOptionPane.showConfirmDialog(new JFrame(),"This option will permanantely convert your wild Pok�mon data to a new format no longer supported by other map editors.\nAre you sure you want to continue?","No More A-Map 4 u", JOptionPane.YES_NO_OPTION);
				if(result == JOptionPane.YES_OPTION) {
